...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqLiteHelper.queryData("CREATE TABLE IF NOT EXISTS IMAGE (Id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR, price VARCHAR, image BLOG)");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE_GALERY){
            if (grantResults.length >0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(getApplicationContext(), "You don't have permission to acces file location!", Toast.LENGTH_SHORT).show();
            }
            return;
        }
